...
\begin{minipage}{0.6\textwidth}
    \begin{itemize}
        ...
        \item Em 2002 foi lançada a primeira GPU de Propósito Geral (GPGPU)
        \item Os principais fabricantes de GPUs são a \alert{Nvidia} e a \alert{AMD}
        \item Em 2005 a Nvidia lançou \alert{CUDA}
        \item Carros autônomos, Realidade Virtual, Inteligencia Artificial, $\dots$
    \end{itemize}
\end{minipage}
\hfil
...
\begin{minipage}{0.35\textwidth}
    \begin{itemize}
        ...
        \item 65 KB do arquivo de registradores
...
\begin{minipage}{0.6\textwidth}
    \begin{itemize}
        \item Clusters de Processamento Gráfico (GPC)
        ...
        \item 256 KB do arquivo de registradores
        \item 2 MB  de memória cache L2
        \item 4 escalonadores de warps
        \item 128 cores de Mawell têm 90\% do desempenho de 192 cores da Kepler
\end{itemize}
\end{minipage}\hfill
\begin{minipage}{0.4\textwidth}
...
\frametitle{Arquitetura Pascal}
    \begin{itemize}
        ...
        \item 256 KB do arquivo de registradores
        \item 4096 KB de cache L2
        \item 4096-bit do barramento de interface de memória
        \item Um escalonador de warps
...
%\frame{
%    \frametitle{Open Compute Language (OpenCL)}
%\begin{minipage}{0.575\textwidth}
%    2 tipos de execução: Data Parallel e Task Parallel.\\ Em OpenCL existem 4 locais diferentes para a memória
%\end{minipage}\hfil
%\begin{minipage}{0.4\textwidth}
%    \begin{table}
%        \small
%        \textit{\bf N-Dimensional Range}
%        \begin{tabular}{|| l | r ||}
%            \hline
%            \bf CUDA & \bf OpenCL\\\hline
%            grid & NDRange\\\hline
%            block threads & work group\\\hline
...
%\begin{figure}[htpd]
%    \centering
%    \includegraphics[scale=.225]{modelMemorOpenCL}
%\end{figure}
%}
...
\item 1a. geração x100 Knights Corner: 22 nm
\item 2a. geração x200 Knights Landing: 14 nm
\item 3a. geração Knights Hill: 10 nm
\end{itemize}
